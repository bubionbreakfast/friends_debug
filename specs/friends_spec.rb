...
class TestFriends < MiniTest::Test
  ...
  # def test_getting_likes_to_eat
  #   result = get_likes_to_eat(@person2)
  #   assert_equal(:snacks, result)
  # end
...
# def test_adding_friend
#   result = add_friend(@person1)
...
# end
  ...
  def test_getting_total_of_everyones_money
...
# def test_if_lenders_money_has_changed
#   result = money_difference(lender, lendee, amount)
